...
export const createSection = (mysql, section, applicant, is_last_in_chapter, is_last_in_book) => {
    ...
    section.number++;
    mysql.query(`INSERT INTO \`sections\` (\`id_chapter\`, \`text\`, \`number\`, \`finished_at\`, \`vote_finished_at\`, \`is_last_in_chapter\`, \`is_last_in_book\`)
